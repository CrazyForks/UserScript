...
| 脚本名称                                                               | 脚本说明                                                                                    | 安装链接                                                                                                                  |
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| GitHub 文件夹下载器                                                    | 点击按钮后跳转至 ztools.zishu.me 进行 GitHub 文件夹下载                                     | [Greasyfork](https://raw.githubusercontent.com/anghunk/scripts/refs/heads/main/github-folder-download/greasyfork.user.js) |
